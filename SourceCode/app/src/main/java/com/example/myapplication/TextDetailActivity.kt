...
class TextDetailActivity : ComponentActivity() {
...
@OptIn(ExperimentalMaterial3Api::class)
@Composable
fun TextDetailScreenContent(onBackClick: () -> Unit) {
    Scaffold(
...
@Composable
fun TextDetailActivityPreview() {
    MyApplicationTheme {
        TextDetailScreenContent(onBackClick = {})
    }
}